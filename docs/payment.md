...
- En cas d’amélioration de formule durant cette période, vous bénéficierez **immédiatement** des avantages associés.
- En revanche, si vous choisissez une formule inférieure, vos fonctionnalités seront limitées à celle-ci **à compter de la date d’expiration**. Vos données resteront toutefois sauvegardées et accessibles si vous optez ultérieurement pour une formule supérieure.
